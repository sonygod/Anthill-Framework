...
class AntPoint {
	 ...
	 */
	public function set(aX : Float = 0, aY : Float = 0) : AntPoint {
		x = aX;
		y = aY;
		return this;
	}
	 ...
	 * @return		Возвращает указатель на себя.
	 */
	public function increment(value : Float) : AntPoint {
		x += value;
		y += value;
		return this;
	}
	 ...
	 * @return		Возвращает указатель на себя.
	 */
	public function multiply(value : Float) : AntPoint {
		x *= value;
		y *= value;
		return this;
	}
	 ...
	 * @return		Возвращает указатель на себя.
	 */
	public function divide(value : Float) : AntPoint {
		x /= value;
		y /= value;
		return this;
	}
	 ...
	 */
	public function equal(aX : Float, aY : Float, aDiff : Float = 0.000001) : Bool {
	 ...
	 */
	public function equalPoint(aPoint : AntPoint, aDiff : Float = 0.000001) : Bool {
	...
	public function toString() : String {
		return "[AntPoint x:" + Std.string(x) + " y:" + Std.string(y) + "]";
	}
